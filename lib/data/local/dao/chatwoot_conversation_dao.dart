...
class PersistedChatwootConversationDao extends ChatwootConversationDao {
  ...
  Future<void> deleteConversation() async {
    final conversationIdentifier = _clientInstanceIdToConversationIdentifierBox
        .get(_clientInstanceKey);
  ...
  ChatwootConversation? getConversation() {
    ...
    final conversationIdentifier = int.tryParse(
      conversationidentifierString ?? "",
    );
