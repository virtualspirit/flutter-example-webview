import '/data/chatwoot_repository.dart';
import '/data/local/dao/chatwoot_contact_dao.dart';
import '/data/local/dao/chatwoot_conversation_dao.dart';
import '/data/local/dao/chatwoot_messages_dao.dart';
import '/data/local/dao/chatwoot_user_dao.dart';
import '/data/local/entity/chatwoot_contact.dart';
import '/data/local/entity/chatwoot_conversation.dart';
import '/data/local/entity/chatwoot_message.dart';
import '/data/local/entity/chatwoot_user.dart';
import '/data/local/local_storage.dart';
import '/data/remote/service/chatwoot_client_api_interceptor.dart';
import '/data/remote/service/chatwoot_client_auth_service.dart';
import '/data/remote/service/chatwoot_client_service.dart';
