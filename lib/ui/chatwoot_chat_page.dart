...
import '/ui/chatwoot_chat_theme.dart';
import '/ui/chatwoot_l10n.dart';
...
class _ChatwootChatState extends State<ChatwootChat> {
  ...
  types.TextMessage _chatwootMessageToTextMessage(
  ...
  void _handleMessageSent(types.Message message) {
    final index = _messages.indexWhere((element) => element.id == message.id);
